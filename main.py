...
def add_data():
    ...
    try:
        mainWindow = Tk()
        mainWindow.sourceFile = filedialog.askopenfilename(filetypes=(("ImageFiles", ("*.jpg", "*.png", "*.jpeg")), ("All Files", "*")), parent=mainWindow,title="Please select an image")
    ...
    if mainflag1 == 0:
        ...
        while fl == 0:
            ...
            Button(root1, text="CONFIRM",padx=55, pady=5,command=lambda: clicked(batch.get(), subject.get(), da1.get(), da2.get(), da3.get(), da4.get(),da5.get()), bg="green", fg="white",font=("Arial Bold", 15)).pack()
            Button(root1, text="QUIT", padx=55, pady=5, command=on_closing, bg="red", fg="white",font=("Arial Bold", 15)).pack()
...
def display_data():
    ...
    Label(window, text="Please open below drop down menu.\n", padx=25, pady=40, font=("Arial Bold", 15)).pack(anchor=CENTER)
                    ...
                    with open(filename, 'r') as csvfile:
                        ...
                        if f == 1:
                            ...
                            for i in range(len(a)//2):
                                Label(root, text=a[i][0]+" - "+a[i][e-1]+"\t"+a[i+15][0]+" - "+a[i+15][e-1]).pack()
                        else:
    ...
    Button(window, text="CONFIRM", padx=55, pady=5, command=show, bg="green", fg="white",font=("Arial Bold", 15)).pack()
    Button(window, text="QUIT", padx=55, pady=5, command=on_closingfunchoise, bg="red", fg="white",font=("Arial Bold", 15)).pack()
